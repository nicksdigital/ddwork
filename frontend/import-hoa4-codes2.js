...
// Function to process HOA4 file
async function processHOA4File() {
  const filePath = path.join(__dirname, 'codestxtdd', 'HOA4-1.txt');
  ...
  try {
    ...
    console.error(`Error processing HOA4 file:`, err);
  } finally {
    await pool.end();
  }
}
